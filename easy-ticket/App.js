    ...
    <TimeProvider>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Login">
          ...
          <Stack.Screen name="UsarTicket" component={UsarTicket} options={{ headerShown: false }} />
          <Stack.Screen name="HistoricoTickets" component={HistoricoTickets} />
          <Stack.Screen name="StatusTicketsHoje" component={StatusTicketsHoje} />
        </Stack.Navigator>
      </NavigationContainer>
    </TimeProvider>
  );
